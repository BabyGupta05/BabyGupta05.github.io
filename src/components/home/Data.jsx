...
const Data = () => {
  ...
  return (
    <div className="home__data">
        <h1 className="home__title" id='user-detail-name'>BABY GUPTA
        
        </h1>
        <h3 className='home__subtitle'>MERN : {displayText}</h3>
        <p>Logical and results-driven full stack developer dedicated to building and optimizing user-focused websites and applications.</p>
