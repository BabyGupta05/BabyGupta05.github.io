...
export default function Navbar({ handleClick, boolean }) {
  ...
  const handleDownload = () => {
    window.open('https://drive.google.com/file/d/1mQ2pn5XI0iQSjx_v-ALxBzredbfFx-u2/view?usp=sharing', '_blank');
  };
  ...
  return (
    <nav id="nav-menu" onClick={handleClick}>
      ...
      href={resume} 
      onClick={handleDownload} 
      rel="noreferrer" download={'BabyGupta05'} id="resume-button-1" className="contact-button nav-link resume resume-button second-btn">
        Resume</a>
    </nav>
  );
}
